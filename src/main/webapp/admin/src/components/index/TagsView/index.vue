<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0px 220px 0 0","boxShadow":"none","margin":"0px auto 0","borderColor":"#958344","display":"block","overflow":"hidden","borderRadius":"8px","background":"#f1ede2","borderWidth":"1px","width":"96%","fontSize":"16px","lineHeight":"40px","borderStyle":"solid","height":"40px"}'>
